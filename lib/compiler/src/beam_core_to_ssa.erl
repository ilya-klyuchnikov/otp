...
%% call_type(Mod, Name, [Arg], State) -> bif | call | is_record | is_tagged_struct | error.

-spec call_type(cerl:cerl(), cerl:cerl(), [cerl:cerl()]) -> bif | call | is_record | is_tagged_struct | error.
...
-spec select_types([#iclause{}], [#iclause{}], [#iclause{}], [#iclause{}], [#iclause{}], [#iclause{}], [#iclause{}], [#iclause{}], [#iclause{}], [#iclause{}], [#iclause{}]) -> [{con() | {bif, atom()}, [#iclause{}]}].
